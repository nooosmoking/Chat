...
CREATE TABLE IF NOT EXISTS messages (
    ...
    sender VARCHAR(30) REFERENCES users(id),
    date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP PRIMARY KEY NOT NULL,
    room VARCHAR(30) REFERENCES rooms(id)
);
...
INSERT INTO messages (text, sender, room) VALUES ('Hi!','Ann625', 'friends'), ('What`s new?', 'Ann625', 'friends'), ('Hello', 'Ivan3000', 'friends'), ('I need photos', 'jiordan', 'Egypt');
